...
def jd():
    ...
    return render_template('lab3/jd.html', errors=errors, pass_name=pass_name, shelf=shelf,
...
products = [
    ...
    {'name': 'Samsung Galaxy S24', 'price': 83990, 'brand': 'Samsung', 'color': 'сиреневый'},
...
@lab3.route('/lab3/product')
def index():
    return render_template('lab3/product.html')
