...
def db_connect():
    if current_app.config['DB_TYPE'] == 'postgres':
        ...
        host = '127.0.0.1',
        database = 'arina_babii_knowledge_base',
        user = 'arina_babii_knowledge_base',
        password = '123456'
        )
...
def list():
    ...
    if not articles: 
        return render_template('/lab5/article.html', articles=articles, message='У вас нет ни одной статьи.')  
    
    return render_template('/lab5/article.html', articles=articles) 
